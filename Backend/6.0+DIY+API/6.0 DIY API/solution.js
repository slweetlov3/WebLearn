...
app.patch("/jokes/:id", (req, res) => {
  ...
  const replacementJoke = {
    id: id,
    jokeText: req.body.text || existingJoke.jokeText,//check neu nhu req.body.text ton tai
    jokeType: req.body.type || existingJoke.jokeType,//neu no ton tai thi jokeText = req.body.text, con khongh thi la nhu cu.
  };
  const searchIndex = jokes.findIndex((joke) => joke.id === id);
  jokes[searchIndex] = replacementJoke;
